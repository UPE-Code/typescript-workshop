...
// Type aliases allow us to create names for types
type BoolOrStr = boolean | string;
let isAlive: BoolOrStr = true;
console.log(isAlive);
...
let someStringLength = (<string>someString).length;
console.log(someStringLength);

let anotherString: any = "I'm DaJuan";
let anotherStringLength = (anotherString as string).length;
